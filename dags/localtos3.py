...
data_path=f"/opt/airflow/data/business_data/{business_file_name}"
...
def business_tranfer():
    try:
        ...
        print(f"no new business file file for {batch_date}")
        

             
def scraper_transfer():
#for scraper data transfer  
    scraper_file_path="/opt/airflow/data/scraper/"+date_path+"/"+scraper_file_name+".jl"
...
def weblogs_transfer():
#web log
    web_logs_path="/opt/airflow/data/web_userlogs/"+date_path+"/web_user.log"
